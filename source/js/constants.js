...
(function() {
  ...
  const URL_GET_TEST = "https://reqres.in/api/users?page=2";
  const URL_POST_TEST = "https://reqres.in/api/users";
  const MAX_WAITING_TIME_RESPONSE = 3000; // ms
  const TIME_SHOW_MESSAGE_ERROR_OR_SUCCESS = 3000;
